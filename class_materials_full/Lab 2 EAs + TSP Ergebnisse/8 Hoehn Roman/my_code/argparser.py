...
parser = argparse.ArgumentParser(
    description="Parse TSP files and calculate paths using simple " "algorithms."
)
...
parser.add_argument(
    ...
    dest="need_HC",
    default=False,
    help="calculate the distance traveled by hill climber",
)
...
parser.add_argument(
    ...
    dest="need_EA",
    default=False,
    help="calculate the distance traveled by an evolutionary algorithm",
)

parser.add_argument(
    "-t",
    "--evolutionary-algorithm-txt",
    action="store_true",
    dest="need_EA_txt",
    default=False,
    help="calculate the distance traveled by an evolutionary algorithm and print results in bestresults.txt",
)
